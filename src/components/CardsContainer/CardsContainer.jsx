...
const CardsContainer = ()=>{
  ...
  const [porPagina, _setPorPagina] = useState(15); //POR PAGINA 15 CARDS
  ...
  return(
    <div >
     {/* El componente Paginado, que recibe props y maneja paginado */}
     <Paginado pagina={pagina} setPagina={setPagina} maximo={maximo} allGames={allGames.length} porPagina={porPagina}/>
        
        
        <div className={style.cardContainer} >
{/* .slice() es un método que se utiliza en los arrays en JavaScript para crear una nueva copia de una porción de la array original. Se define mediante dos índices (inicio y fin)  */}
        {allGames.slice(
